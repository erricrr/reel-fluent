...
async function downloadAudio(url: string, outputPath: string) {
  ...
  // Anti-bot approaches specifically for cloud platforms like Railway
  const approaches = [
    {
      name: 'yt-dlp with embed bypass (cloud-optimized)',
      command: [
        'yt-dlp',
        '--extract-audio',
        '--audio-format', 'mp3',
    ...
    {
      name: 'yt-dlp with TV client (bypass bot detection)',
      command: [
        'yt-dlp',
        '--extract-audio',
        '--audio-format', 'mp3',
        ...
        '--referer', '"https://www.youtube.com/"',
        '--extractor-retries', '12',
        '--fragment-retries', '18',
        '--retry-sleep', 'linear=3::15',
        '--socket-timeout', '75',
        '--no-check-certificates',
        '--sleep-interval', '3',
    ...
    {
      name: 'yt-dlp embed extractor (Railway-optimized)',
      command: [
        'yt-dlp',
        '--extract-audio',
        '--audio-format', 'mp3',
        ...
        '--force-ipv4',
        '--geo-bypass',
        '--extractor-args', 'youtube:player_client=mweb,bypass_verification=true',
        ...
        '--add-header', '"CF-Connecting-IP:8.8.8.8"',
        '--extractor-retries', '20',
        '--fragment-retries', '25',
        '--retry-sleep', 'exp=3:600',
        '--socket-timeout', '120',
        '--no-check-certificates',
        '--sleep-interval', '5',
