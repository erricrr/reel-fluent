  ...
  return (
    <div className="max-w-2xl mx-auto py-12 px-4 text-foreground">
      ...
      <div className="space-y-6 text-sm">
        <p>At LinguaClip, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our language learning service.</p>

        <h2 className="text-xl font-semibold mt-6 mb-2">1. Information We Collect</h2>
        <p>When you use LinguaClip, we collect a limited amount of information:</p>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">2. Media Files and Content</h2>
        <p>When you upload media files to LinguaClip:</p>
        <ul className="list-disc ml-6 space-y-2">
        ...
        <ul className="list-disc ml-6 space-y-2">
          <li>To provide the LinguaClip language learning service.</li>
        ...
        <p>LinguaClip is not intended for children under 13 years of age. We do not knowingly collect personal information from children under 13.</p>

        <h2 className="text-xl font-semibold mt-6 mb-2">7. Beta Version Notice</h2>
        <p>LinguaClip is currently in beta testing. During this phase, we may collect additional diagnostic information to improve the service. Our privacy practices may evolve as we develop the service.</p>

        <h2 className="text-xl font-semibold mt-6 mb-2">8. Changes to This Policy</h2>
        <p>We may update this Privacy Policy from time to time to reflect changes in our practices or for legal reasons. Continued use of LinguaClip after changes constitutes acceptance of the updated policy.</p>
